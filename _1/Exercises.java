...
//        } NON FUNZIONA. DA ERRORE CON containsAll(Set.of(...)) E NON PARTE IL RUN
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [apple, banana, orange, kiwi, mango]   [banana, orange, apple, kiwi, mango] stamperà solo una volta i valori inseriti
        ...
        //2b. What will this output? [apple, banana, grapes, pear, mango, kiwi, orange] [banana, orange, apple, kiwi, pear, mango, grapes]
                                        // stamperà una volta sola i valori doppioni e aggiunge i valori nuovi
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
        ...
        //int max = Integer.MAX_VALUE;          // IL CODICE PRIMA ERA COSI'
        //int min = Integer.MIN_VALUE;


        int max = Integer.MIN_VALUE;    //CAMBIANDOLO IN QUESTO MODO FUNZIONA. UN ALTRO MODO CHE MI VIENE IN MENTE è SOLO RIASSEGNADO I VALORI NEL CICLO FOR
...
//        }
        ...
        // Your code
        for (Integer a : setA){
            for (Integer b : setB){// il secondo for è richiesto dall'esercizio ma non serve
                if (setB.contains(a)){
    ...
    private static void exercise4() {
        ...
        // PROVA 1
//        for (Integer lower : orderedNumbers){
//            if (min>lower){
//                min = lower;
//            }
//        }
